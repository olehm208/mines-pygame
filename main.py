...
def start(index):
    global current_settings, fieldHeight, fieldWidth, bombnum, finish, game, current_flag_num, max_flag_num, flag_txt, sec, clicked_sprites, clicked_sprites2, hovered_sprites, stop_bliting, options
    fieldHeight = options[index]["height"]
    fieldWidth = options[index]["width"]
    bombnum = options[index]["mines"]
    finish = False
    game = True
    current_flag_num = 0
                        ...
                        with open("custom_field.txt", "r") as f:
                            ...
                            if len(data) >= 4:
                                ...
                                try:
                                    ...
                                    options.append(options_and_cust) 
                                    buttons(4)
                                except ValueError:
